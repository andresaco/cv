...
\begin{aside} % In the aside, each new line forces a line break
  ...
  Decision-making, Adaptability, Conflict resolution, Team building, Performance management
  \section{technologies}
  Python, Java, Apache Spark, AWS, Data
\end{aside}
...
\textbf{Engineering \& Product Leader} with a 360º vision of the software development lifecycle. 
My extensive technical background provides the necessary expertise to guide large-scale projects 
while maintaining a sharp focus on strategic business objectives. With a proven track record 
in international environments, I currently specialize in the governance and optimization 
of \textbf{cloud infrastructures} and the implementation of \textbf{AI-driven solutions}. 
I excel at aligning stakeholder requirements with technical team capabilities, fostering 
a culture of continuous improvement and technological innovation.
...
{{\normalfont Universidad Internacional de La Rioja}}
{unir.net}
{Master de Formacion Permanente en IA para el sector financiero}
